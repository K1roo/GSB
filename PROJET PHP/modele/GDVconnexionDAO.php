...
class connexionDAO
{
     ...
     static private $connexionVisiteurs=NULL;
    ...
    try {
     ...
     static public function createConnexion(){
         if(connexionDAO::$connexionVisiteurs==NULL){
             connexionDAO::$connexionVisiteurs = new connexionDAO();
         }
         return connexionDAO::$connexionVisiteurs;
     }
}
