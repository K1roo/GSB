...
<body>
    <div class="container">
        ...
        <div class="jumbotron">
            ...
            <p class="lead"> Le laboratoire Galaxy Swiss Bourdin (GSB) L'activité commerciale d'un laboratoire pharmaceutique est principalement réalisée par les visiteurs médicaux. </p>
            <p class="lead"> 
            <p>
          <i class=""></i> <H2></H2>  <H2> </H2>
          <video autoplay muted loop width="1050" height="480" autoplay muted loop>
  <source src="tvidd.mp4" type="video/mp4"> 
        ...
        <div id="slides" class="carousel slide" data-ride="carousel">
            <!-- Indicators -->
                ...
                <div img src="testt.jpg" style="width:100%;">
            </div>
